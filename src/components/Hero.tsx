        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-slide-in-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-brand-navy leading-[1.08] mb-6 tracking-tight">
              La flota que mueve
              <span className="block text-gold-gradient mt-1">toda Latinoamerica</span>
            </h1>

            <p className="text-lg text-brand-muted leading-relaxed mb-8 max-w-lg">
              Venta, alquiler y servicio tecnico de montacargas nuevos y usados.
              Distribuidor autorizado de las marcas lideres con presencia en 6 paises.
            </p>
            ...
            <div className="flex gap-8 mb-10">
              <div className="border-l-4 border-brand-gold pl-4">
                ...
                <p className="text-brand-muted text-sm font-medium">Anos de experiencia</p>
              </div>
              <div className="border-l-4 border-brand-navy pl-4">
                <p className="rca-stat text-brand-navy">{countriesCount}</p>
                <p className="text-brand-muted text-sm font-medium">Paises en LATAM</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                href={`https://wa.me/${WA}?text=${encodeURIComponent("Hola, necesito asesoria para mi operacion logistica")}`}
                target="_blank"
          ...
          <div className="relative animate-slide-in-right">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-brand-navy/20">
              <div className="aspect-[4/3] bg-gray-200">
                <img
                  ...
                  alt="Montacargas Grupo RCA en operacion"
            ...
            {/* Floating certification — bottom right */}
            <div className="absolute -bottom-3 -right-3 bg-white border border-gray-100 p-4 rounded-xl shadow-lg hidden lg:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-brand-navy">Certificacion ISO</p>
                  <p className="text-[10px] text-brand-muted">Calidad garantizada</p>
                </div>
              </div>
            </div>
