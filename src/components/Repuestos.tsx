...
const categories = [
  { name: "Cauchos y Llantas", desc: "Solidos, neumaticos y de poliuretano", msg: "Hola, necesito cotizar cauchos para montacargas" },
  { name: "Baterias y Cargadores", desc: "Litio, acido-plomo y cargadores industriales", msg: "Hola, necesito cotizar baterias para montacargas" },
  { name: "Sistema Hidraulico", desc: "Bombas, cilindros, mangueras y sellos", msg: "Hola, necesito repuestos del sistema hidraulico" },
  { name: "Motor y Transmision", desc: "Repuestos originales y alternativos", msg: "Hola, necesito repuestos de motor y transmision" },
  { name: "Sistema Electrico", desc: "Contactores, cables, controladores", msg: "Hola, necesito repuestos del sistema electrico" },
  { name: "Cadenas y Rodillos", desc: "Para mastiles y sistemas de elevacion", msg: "Hola, necesito cadenas y rodillos para montacargas" },
];
    ...
    <section id="repuestos" className="py-20 bg-brand-cream rca-blueprint">
      <div ref={ref} className={`max-w-7xl mx-auto px-4 sm:px-6 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <div className="mt-12 bg-brand-navy rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            <h3 className="font-bold text-white text-lg">Garantia en todos nuestros repuestos</h3>
            <p className="text-white/60 text-sm mt-1">Trabajamos con repuestos originales y alternativos certificados. Soporte tecnico para instalacion y mantenimiento en toda Venezuela.</p>
          </div>
