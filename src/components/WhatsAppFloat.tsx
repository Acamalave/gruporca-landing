    ...
    <div className="fixed bottom-6 right-6 z-50">
      {open && (
        <div className="mb-3 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden w-72 animate-fade-in-up">
          ...
          <div className="p-2">
            {departments.map((d, i) => (
              <a key={i} href={`https://wa.me/${WA}?text=${encodeURIComponent(d.msg)}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
